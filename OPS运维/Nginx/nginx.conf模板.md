...
# add for compress
  ...
  proxy_temp_path   /data/tmp/proxy_temp_dir;
  proxy_cache_path  /data/tmp/proxy_temp_dir/tmp/proxy_cache_dir  levels=1:2   keys_zone=cache_one:500m inactive=1d max_size=30g;
  ...
  access_log   /gomeo2o/logs/nginx/access.log main; 
  include conf.d/*.conf;
